...
if (!$setupDatabase-> checkErrorExist("apache")) {
    $currentCategory = $getDatabase-> getCustomData("categories", "id", "2");
    $currentProducts = $getDatabase-> getCustomData("products", "categoryID", "2");
    $productsStatus = true;
...
<head>
    ...
    <title>PHPhp Market - Desktop Business</title>
</head>
<body dir="rtl">
