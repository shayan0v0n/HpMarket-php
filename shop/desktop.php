...
if (!$setupDatabase-> checkErrorExist("apache")) {
    $currentCategory = $getDatabase-> getCustomData("categories", "id", "5");
    $currentProducts = $getDatabase-> getCustomData("products", "categoryID", "5");
    $productsStatus = true;
...
<head>
    ...
    <title>PHPhp Market - Desktop</title>
</head>
<body dir="rtl">
