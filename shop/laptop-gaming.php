...
if (!$setupDatabase-> checkErrorExist("apache")) {
    $currentCategory = $getDatabase-> getCustomData("categories", "id", "6");
    $currentProducts = $getDatabase-> getCustomData("products", "categoryID", "6");
    $productsStatus = true;
...
<head>
    ...
    <title>PHPhp Market - Desktop Gaming</title>
</head>
<body dir="rtl">
